...
Full agent fleet health check — connectivity, performance, and cost. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the agent-health intel instructions to produce the output."},
