...
Generate a well-researched article on any topic using live data. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the article intel instructions to produce the output."},
