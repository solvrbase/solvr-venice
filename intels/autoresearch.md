...
Auto-research solutions to technical problems using news and GitHub. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the autoresearch intel instructions to produce the output."},
