...
Auto-generate changelogs from development activity and news. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the changelog intel instructions to produce the output."},
