...
Spotlight top contributors to the Solvr ecosystem. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the contributor-spotlight intel instructions to produce the output."},
