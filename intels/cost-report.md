...
API usage and cost report — track endpoint usage, tier status, and spend. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the cost-report intel instructions to produce the output."},
