...
Create a new Solvr intel file for any agent use case. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the create-intel intel instructions to produce the output."},
