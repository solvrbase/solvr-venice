...
Build and optimize daily routines using intelligence signals. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the daily-routine intel instructions to produce the output."},
