...
Startup and VC deal flow monitor — funding rounds, new launches, M&A. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the deal-flow intel instructions to produce the output."},
