...
Deep research on any topic using news + world data + context synthesis. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the deep-research intel instructions to produce the output."},
