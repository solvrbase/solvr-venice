...
Analyze token holder distribution and concentration risk. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the distribute-tokens intel instructions to produce the output."},
