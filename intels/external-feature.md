...
Research and integrate external APIs or features into your agent. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the external-feature intel instructions to produce the output."},
