...
Farcaster community digest — trending casts and channel highlights. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the fargester-digest intel instructions to produce the output."},
