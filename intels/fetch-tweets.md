...
Fetch and synthesize crypto Twitter activity via news and trending data. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the fetch-tweets intel instructions to produce the output."},
