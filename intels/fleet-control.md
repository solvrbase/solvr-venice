...
Coordinate multiple Solvr agents — dispatch, monitor, and aggregate results. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the fleet-control intel instructions to produce the output."},
