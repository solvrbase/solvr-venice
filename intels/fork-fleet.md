...
Fork and customize Solvr intels for a specialized agent fleet. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the fork-fleet intel instructions to produce the output."},
