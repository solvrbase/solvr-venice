...
Surface high-priority open issues from tracked repositories. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the github-issues intel instructions to produce the output."},
