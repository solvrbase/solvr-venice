...
Monitor specific GitHub repositories for new activity — stars, issues, releases. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the github-monitor intel instructions to produce the output."},
