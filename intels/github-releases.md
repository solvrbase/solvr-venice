...
Monitor GitHub project releases and surface breaking changes. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the github-releases intel instructions to produce the output."},
