...
Daily GitHub trending repositories digest by language and topic. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the github-trending intel instructions to produce the output."},
