...
Tech community digest — top tech news + trending GitHub repos. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the hacker-news-digest intel instructions to produce the output."},
