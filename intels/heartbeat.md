...
Agent health check — verify all required endpoints are reachable. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the heartbeat intel instructions to produce the output."},
