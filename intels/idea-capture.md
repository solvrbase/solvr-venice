...
Capture and enrich ideas with current data and trend context. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the idea-capture intel instructions to produce the output."},
