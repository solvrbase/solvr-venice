...
Evaluate intel quality — score output quality and identify degraded intels. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the intel-evals intel instructions to produce the output."},
