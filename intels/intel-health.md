...
Monitor intel health — detect failing intels before they cause issues. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the intel-health intel instructions to produce the output."},
