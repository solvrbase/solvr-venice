...
Intel performance leaderboard — ranked by value delivered. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the intel-leaderboard intel instructions to produce the output."},
