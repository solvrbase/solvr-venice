...
Auto-repair broken intels by diagnosing root cause and applying fixes. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the intel-repair intel instructions to produce the output."},
