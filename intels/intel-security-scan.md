...
Security audit for agent intels — check for prompt injection and unsafe patterns. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the intel-security-scan intel instructions to produce the output."},
