...
Check for intel updates from the Solvr repository. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the intel-update-check intel instructions to produce the output."},
