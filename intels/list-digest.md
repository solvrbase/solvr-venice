...
Create a curated digest list from any topic or source. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the list-digest intel instructions to produce the output."},
