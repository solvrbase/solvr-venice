...
Track Kalshi prediction markets via Polymarket + macro news proxy. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the monitor-kalshi intel instructions to produce the output."},
