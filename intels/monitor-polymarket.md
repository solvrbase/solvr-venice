...
Track Polymarket prediction markets — prices, volume, top moving markets. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the monitor-polymarket intel instructions to produce the output."},
