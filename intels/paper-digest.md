...
Research paper digest — latest findings from science, AI, and tech. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the paper-digest intel instructions to produce the output."},
