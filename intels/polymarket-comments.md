...
Surface top Polymarket prediction markets with commentary context. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the polymarket-comments intel instructions to produce the output."},
