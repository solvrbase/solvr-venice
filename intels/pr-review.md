...
AI-assisted pull request review framework using context from tech news and security. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the pr-review intel instructions to produce the output."},
