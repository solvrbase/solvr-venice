...
Analyze any project from multiple angles — tech, community, market. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the project-lens intel instructions to produce the output."},
