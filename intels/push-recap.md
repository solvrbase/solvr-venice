...
Generate a push recap — what changed, why it matters. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the push-recap intel instructions to produce the output."},
