...
Agent self-reflection — review performance, identify improvements. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the reflect intel instructions to produce the output."},
