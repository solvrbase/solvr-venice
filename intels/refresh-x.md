...
Refresh X/Twitter content strategy with trending topics and real data. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the refresh-x intel instructions to produce the output."},
