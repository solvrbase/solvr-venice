...
Regulatory compliance monitor — track new rules affecting your domain. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the reg-monitor intel instructions to produce the output."},
