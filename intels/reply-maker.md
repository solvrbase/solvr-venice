...
Generate smart, data-backed replies to trending topics. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the reply-maker intel instructions to produce the output."},
