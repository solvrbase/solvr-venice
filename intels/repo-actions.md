...
Automate repository actions using Solvr intelligence as triggers. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the repo-actions intel instructions to produce the output."},
