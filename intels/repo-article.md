...
Generate a technical article about a GitHub repository. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the repo-article intel instructions to produce the output."},
