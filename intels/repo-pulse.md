...
Repository health pulse — activity, community, and momentum check. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the repo-pulse intel instructions to produce the output."},
