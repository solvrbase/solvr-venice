...
Full repository security scan — dependencies, contracts, and secrets. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the repo-scanner intel instructions to produce the output."},
