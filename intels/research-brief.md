...
Quick research brief (< 300 words) on any topic. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the research-brief intel instructions to produce the output."},
