...
Multi-source news aggregator digest powered by Solvr. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the rss-digest intel instructions to produce the output."},
