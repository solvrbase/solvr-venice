...
Aggregate Solvr news endpoints into a single RSS-style feed. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the rss-feed intel instructions to produce the output."},
