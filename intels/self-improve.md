...
Agent self-improvement — identify new intels to add and existing ones to tune. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the self-improve intel instructions to produce the output."},
