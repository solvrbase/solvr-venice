...
Spawn a new agent instance with specific intels and configuration. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the spawn-instance intel instructions to produce the output."},
