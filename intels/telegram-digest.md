...
Crypto Telegram community digest via news + on-chain data proxy. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the telegram-digest intel instructions to produce the output."},
