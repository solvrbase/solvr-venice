...
Daily threat intelligence brief — crypto hacks, rug pulls, and security incidents. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the threat-intel intel instructions to produce the output."},
