...
Monitor tracked tokens for price/volume anomalies. Alert when 24h change >10% or volume spikes. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the token-alert intel instructions to produce the output."},
