...
Top 10 winners and losers today with momentum signal tags. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the token-movers intel instructions to produce the output."},
