...
Project treasury analysis — token value, diversification, runway estimate. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the treasury-info intel instructions to produce the output."},
