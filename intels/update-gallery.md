...
Update the Solvr intel gallery with new intels and usage stats. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the update-gallery intel instructions to produce the output."},
