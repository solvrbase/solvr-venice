...
Scan for vulnerabilities in code dependencies and smart contracts. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the vuln-scanner intel instructions to produce the output."},
