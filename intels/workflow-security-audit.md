...
Security audit for GitHub Actions and CI/CD workflows. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the workflow-security-audit intel instructions to produce the output."},
