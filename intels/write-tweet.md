...
Write high-engagement tweets backed by live data and news. Solvr supplies the data; Venice synthesizes the output.
...
r = venice.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "Follow the write-tweet intel instructions to produce the output."},
